            ...
            if (title && this.enabled) {
                ...
                switch (gravity.charAt(0)) {
                    case 'n':
                        ...
                        tp = {top: pos.top + pos.height + this.options.offset, left: pos.left + pos.width / 2 - actualWidth};
                        break;
                    case 's':
                        tp = {top: pos.top - actualHeight - this.options.offset-20, left: pos.left + pos.width / 2 - actualWidth / 2};
                        break;
                    case 'e':
